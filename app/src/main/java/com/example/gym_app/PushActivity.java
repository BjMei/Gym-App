...
public class PushActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Spinner mit Übungen befüllen - mit weißer Schrift
        adapter = ArrayAdapter.createFromResource(this,
            R.array.push_exercises, R.layout.spinner_item_white);
        ...
        btnViewHistory.setOnClickListener(v -> {
            ...
            intent.putExtra(TrainingHistoryActivity.EXTRA_WORKOUT_TYPE, WorkoutStorage.TYPE_PUSH);
    ...
    private void loadLastWorkout(String exercise) {
        WorkoutStorage.LastWorkout lastWorkout = WorkoutStorage.getLastWorkout(this, WorkoutStorage.TYPE_PUSH, exercise);
    ...
    private void saveEntry() {
        ...
        WorkoutStorage.saveDetailedWorkout(this, WorkoutStorage.TYPE_PUSH, exercise, storageSets);
    ...
    private void saveWorkoutSummary(String exercise, List<Set> sets) {
        ...
        WorkoutStorage.addWorkout(this, WorkoutStorage.TYPE_PUSH, builder.toString());
    }
    ...
    private void saveCardioEntry() {
        ...
        try {
            ...
            WorkoutStorage.saveCardioSession(this, WorkoutStorage.TYPE_PUSH, cardioExercise, minutes);
